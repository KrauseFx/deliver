    ...
    def self.available_options
      @options ||= [
        ...
        FastlaneCore::ConfigItem.new(key: :primary_first_sub_category,
                                     description: "Metadata: The english name of the primary first sub category(e.g. `Puzzle`, `Trivia`)",
                                     optional: true,
                                     is_string: true),
        FastlaneCore::ConfigItem.new(key: :primary_second_sub_category,
                                     description: "Metadata: The english name of the primary second sub category(e.g. `Puzzle`, `Trivia`)",
                                     optional: true,
                                     is_string: true),
